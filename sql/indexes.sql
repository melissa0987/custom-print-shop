...
-- INDEXES 
-- ============================================
-- Indexes for faster lookups for admin_users
CREATE INDEX idx_admin_users_email ON admin_users(email);
CREATE INDEX idx_admin_users_username ON admin_users(username);
CREATE INDEX idx_admin_users_role ON admin_users(role);
CREATE INDEX idx_admin_users_active ON admin_users(is_active);

-- Indexes for faster lookups customers
...
-- Indexes for filtering products
CREATE INDEX idx_products_category_id ON products(category_id);
CREATE INDEX idx_products_active ON products(is_active);

-- Indexes for shopping_carts lookups
...
-- Indexes for order_item_customizations lookups
CREATE INDEX idx_order_item_customizations_order_item_id ON order_item_customizations(order_item_id);
CREATE INDEX idx_order_item_customizations_key ON order_item_customizations(customization_key);


-- Indexes for uploaded_files queries
...
-- Index for order_status_history queries
CREATE INDEX idx_order_status_history_order_id ON order_status_history(order_id);

-- Indexes for admin_activity_log log
